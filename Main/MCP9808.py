...
class MCP9808(object):
    ...
    # ------------------------------------------
    #   T_RES_MIN   0.5閹虹煰        30 ms
    #   T_RES_LOW   0.25閹虹煰       65 ms
    #   T_RES_AVG   0.125閹虹煰     130 ms
    #   T_RES_MAX   0.0625閹虹煰    250 ms
    #
...
i2cTemp=MCP9808(i2c=i2c)
temp, frac = i2cTemp.read_int()
temperature=int(temp)+int(frac)/100
print(temperature)
